...
export const ReservationHistoryCardView = () => {
        ...
        {reservations.map((reservation, index) => (
          <div key={index} className="p-4 bg-white rounded-lg shadow-md">
            <div className="flex flex-col space-y-2">
              ...
              <div className="text-sm text-gray-800">
                <span className="font-bold">Date prévue: </span>
              ...
              <div className="text-sm font-bold text-green-500">
                <span className="font-bold">Status réservation: </span>
                {reservation.bookingStatus}
              </div>
              <div
                className={`text-sm font-bold ${statusColorMap[reservation.serviceStatus] || 'text-gray-500'}`}
              >
                <span className="font-bold">Status prestation: </span>
                {reservation.serviceStatus}
              </div>
              <div className="flex justify-between items-center">
                <button
                  className="py-2 px-4 text-sm font-semibold rounded-sm border border-gray-400 text-gray-800 hover:border-gray-500 hover:text-gray-500 disabled:opacity-50"
                  onClick={() => {
                ...
                >
                  ...
                  >
                    <button className="py-2 px-4 text-sm font-semibold rounded-sm border border-gray-400 text-gray-800 hover:border-gray-500 hover:text-gray-500 disabled:opacity-50">
                      Messagerie
                    </button>
                  </Badge>
                </Link>
